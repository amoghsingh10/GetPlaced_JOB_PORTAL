...
const Job = ({job}) => {
  ...
  return (
    ...
    <div className='flex items-center justify-between'>
        ...
        <button   style={{backgroundColor: "#F3F4F6"}}><BookmarkIcon style={{color:"#8E44AD"}} /></button>
    </div>
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/1200px-Google_%22G%22_logo.svg.png" alt="User Avatar" className="w-8 h-8 rounded-full object-cover" />
    ...
    <div className='flex items-center gap-4 mt-4'>
        <button onClick={()=> navigate(`/Description/${jobId}`)} variant="outline"  style={{backgroundColor: "#F3F4F6",color:"#8E44AD"}}>Details</button>
        <button  style={{backgroundColor: "#F3F4F6",color:"#8E44AD"}}>Save For Later</button>
    </div>
</div>
